...
const Favourite = () => {
    ...
    useEffect(() => {
        fetch('https://ide-decfdfebbdedccaddfdbbeaaefacc.project.examly.io/proxy/8080/favourite')
    ...
    const removeFromFavorites = (recipeId) => {
        ...
        setData(updatedData);
        axios.delete(`https://ide-decfdfebbdedccaddfdbbeaaefacc.project.examly.io/proxy/8080/favourite/${recipeId}`)
            .then(res => {
